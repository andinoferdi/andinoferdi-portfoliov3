...
const ProjectStats: React.FC<{ project: Project }> = ({ project }) => {
...
const mockProjects: Project[] = [
  {
    ...
    description:
      "A modern, full-stack e-commerce platform built with Next.js and TypeScript. Features include user authentication, product catalog, shopping cart, payment integration, and admin dashboard. The platform is designed with a focus on performance, accessibility, and user experience.",
  ...
  },
  {
    ...
    description:
      "A collaborative task management application with real-time updates, team collaboration features, and intuitive project organization. Built with modern web technologies for optimal performance and user experience.",
    image: "/placeholder.svg?height=400&width=600",
    link: "https://example.com",
    github: "https://github.com/EkiZR",
...
const ProjectDetails: React.FC<ProjectDetailsProps> = ({ id }) => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    const selectedProject = mockProjects.find((p) => String(p.id) === id);
