...
const AnimatedBackground: React.FC = () => {
          ...
          prevSquares.map((square) => {
            ...
            if (distance < HOVER_RADIUS) {
              ...
              const targetIntensity =
                Math.max(0, 1 - distance / HOVER_RADIUS) * MAX_INTENSITY;
  ...
  }, [isMouseInside, FADE_SPEED, mounted]);
  ...
  return (
    ...
    >
      ...
      {/* Render effects only after mounting */}
      {mounted && (
        <>
          ...
          <div className="absolute inset-0 w-full h-full opacity-3.5">
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle, hsl(var(--blue-500) / 0.056) 0%, transparent 70%)",
              }}
            />
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle, hsl(var(--primary) / 0.042) 0%, transparent 70%)",
              }}
            />
          </div>
        </>
